"use client"
import { Product, addCartCookie, deleteCartCookie } from "@/helpers"
...
export const ProductCard: FC<Product> = ({ id, image, name, price, rating }) => {
        ...
        <div className="bg-white shadow rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-100">
            ...
            <div className="px-5 pb-5">
                ...
                <div className="flex items-center mt-2.5 mb-5">
                    ...
                    {
                        Array(rating).fill(0).map((_, i) => <RatingItem key={i} />)
                    }
